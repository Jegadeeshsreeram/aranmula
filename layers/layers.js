...
lyr_Road01_1.set('fieldLabels', {'osm_id': 'no label', 'name': 'inline label - always visible', 'highway': 'inline label - always visible', 'waterway': 'inline label - always visible', 'aerialway': 'inline label - always visible', 'barrier': 'no label', 'man_made': 'no label', 'railway': 'inline label - always visible', 'z_order': 'no label', 'other_tags': 'no label', });
