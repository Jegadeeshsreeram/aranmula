...
map.getView().fit([8524737.899647, 1036890.362201, 8543679.130340, 1047640.482871], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA_PANCHAYAT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (9 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Aranmula ';
            }
